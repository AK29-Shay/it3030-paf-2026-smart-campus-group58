...
- Backend Java runtime upgraded to **Java 25 (LTS)**.
- Spring Boot `4.0.5` supports Java versions up to and including Java 26, so Java 25 is within the supported range.

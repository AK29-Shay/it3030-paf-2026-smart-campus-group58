    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.heroCard}>
          <div>
            <h1 style={styles.heroTitle}>Technician Assigned Tickets</h1>
            <p style={styles.heroText}>
              Review the tickets assigned to this technician, track work
              progress, and open the details or status page for the next action.
            </p>

            <div style={styles.heroButtons}>
              <button style={styles.secondaryButton} onClick={fetchTechnicianTickets}>
                Refresh Tickets
              </button>
            </div>
          </div>
